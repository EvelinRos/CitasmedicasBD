...
<head>
    ...
    <style>
        body {
            ...
            width: 100%;
        height: 100vh;
        background-image:linear-gradient(to top, rgba(16, 16, 98, 0.729) 0%, rgba(65, 60, 60, 0.805) 100%), url(../resources/imagenes/gerente.jpg);
...
<body>
    ...
    <h1 style="color: white;">Registro Gerente</h1>
